                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-xxl-6">
                                                    ...
                                                    <input class="form-control mb-5" id="name" name="name" type="text" placeholder="Nhập tên gói dịch vụ" value="{$product->name}">
                                                    <label class="form-label required" for="month_price">Giá bán</label>
                                                    <div class="row">
                                                        <div class="col-4">
                                                            <input class="form-control mb-5" id="month_price" name="month_price" type="number" placeholder="Giá 1 tháng" value="{$product->month_price}">
                                                        </div>
                                                        <div class="col-4">
                                                            <input class="form-control mb-5" id="quarter_price" name="quarter_price" type="number" placeholder="Giá 3 tháng" value="{$product->quarter_price}">
                                                        </div>
                                                        <div class="col-4">
                                                            <input class="form-control mb-5" id="half_year_price" name="half_year_price" type="number" placeholder="Giá 6 tháng" value="{$product->half_year_price}">
                                                        </div>
                                                        <div class="col-4">
                                                    ...
                                                    <div class="input-group mb-5">
                                                        <input class="form-control" data-bs-toggle="tooltip" title="Mặc định là 0" id="traffic" name="traffic" type="number" placeholder="Nhập dung lượng cho gói" value="{$product->traffic}">
                                                        <span class="input-group-text">GB</span>
                                                    </div>    
                                                    <label class="form-label required" for="class">Cấp độ của gói</label>
                                                    <input class="form-control mb-5" data-bs-toggle="tooltip" title="Mặc định là 0" id="class" name="class" type="number" placeholder="Nhập cấp độ gói" value="{$product->class}">
                                                    
                                                </div>
                                                <div class="col-xxl-6">
                                                    <label class="form-label" for="stock">Số lượng gói</label>
                                                    <input class="form-control mb-5" id="stock" name="stock" type="number" placeholder="Mặc định là không giới hạn" value="{$product->stock}" data-bs-toggle="tooltip" title="0 Nghĩa là không có giới hạn">
                                                    ...
                                                    <div class="input-group mb-5">
                                                        <input class="form-control" id="speed_limit" name="speed_limit" type="number" placeholder="Mặc định là không giới hạn" value="{$product->speed_limit}" data-bs-toggle="tooltip" title="0 Nghĩa là không có giới hạn">
                                                        <span class="input-group-text">Mbps</span>
                                                    </div>
                                                    <label class="form-label" for="ip_limit">Giới hạn thiết bị</label>
                                                    <div class="input-group mb-5">
                                                        <input class="form-control" id="ip_limit" name="ip_limit" type="number" placeholder="Mặc định là không giới hạn" value="{$product->ip_limit}" data-bs-toggle="tooltip" title="0 Nghĩa là không có giới hạn">
                                                        <span class="input-group-text">IP</span>
                                                    </div>
                                                    <label class="form-label required" for="sort">Thứ tự sắp xếp</label>
                                                    <input class="form-control mb-5" data-bs-toggle="tooltip" title="Thứ tự sắp xếp của gói" id="sort" name="sort" type="number" placeholder="Thứ tự sắp xếp" value="{$product->sort}">
                                                    <label class="form-label required" for="group">Nhóm của gói</label>
                                                    <input class="form-control" data-bs-toggle="tooltip" title="0 Nghĩa là không nhóm" id="group" name="group" type="number" placeholder="Mặc định là không nhóm" value="{$product->user_group}">
                                                </div>
                                            </div>
                                        </div>  
                                    </div>
