<?php
/* Smarty version 4.3.4, created on 2023-12-15 19:50:16
  from '/www/wwwroot/sieuthi5g.com/resources/views/zero/admin/node/create.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_657c3d7862a798_66996231',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f5caad48c94ae871ab8202677c38417896e85db4' => 
    array (
      0 => '/www/wwwroot/sieuthi5g.com/resources/views/zero/admin/node/create.tpl',
      1 => 1701742760,
      2 => 'file',
    ),
  ),
...
function content_657c3d7862a798_66996231 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="vi">
    <head>
                                    ...
                                    <div class="card mb-5">
                                        <div class="card-header card-flush">
                                            ...
                                            <div class="card-toolbar">
                                                <button class="btn btn-sm btn-primary fw-bold me-3" data-bs-toggle="modal" data-bs-target="#zero_modal_node_config_template">Mẫu cấu hình</button>
                                                <button class="btn btn-sm btn-primary fw-bold" onclick="zeroAdminCreateNode()">
                                                <i class="bi bi-cloud-plus fs-3"></i>Tạo máy chủ
                                                </button>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                        ...
                                        <div class="col-xxl-6">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <input class="form-control mb-5" id="name" name="name" type="text" placeholder="Nhập tên máy chủ" value="">
                                                    <label class="form-label required" for="server">Địa chỉ máy chủ</label>
                                                    <input class="form-control mb-5" data-bs-toggle="tooltip" title="Nhập địa chỉ máy chủ (SubDomain)" id="server" name="server" type="text" placeholder="Nhập địa chỉ máy chủ" value="">
                                                    <label class="form-label required" for="node_ip">IP Máy chủ</label>
                                                    <input class="form-control mb-5" id="node_ip" name="node_ip" title="Có thể không nhập nếu đã nhập địa chỉ" type="text" placeholder="Nhập IP máy chủ" value="">
                                                    ...
                                                    <select class="form-select mb-5" id="node_flag">
                                                        <option value="vietnam" data-kt-select2-country="/theme/galaxy/media/flags/vn.svg">Việt Nam</option>
                                                        <option value="singapore" data-kt-select2-country="/theme/galaxy/media/flags/singapore.svg">Singapore</option>
                                                        <option value="japan" data-kt-select2-country="/theme/galaxy/media/flags/japan.svg">Nhật Bản</option>
                                                        <option value="united-states" data-kt-select2-country="/theme/galaxy/media/flags/united-states.svg">Hoa Kỳ</option>
                                                        <option value="united-kingdom" data-kt-select2-country="/theme/galaxy/media/flags/united-kingdom.svg">Vương Quốc Anh</option>
                                                        <option value="canada" data-kt-select2-country="/theme/galaxy/media/flags/canada.svg">Canada</option>
                                                        <option value="hong-kong" data-kt-select2-country="/theme/galaxy/media/flags/hong-kong.svg">HongKong</option>                                                
                                                        <option value="south-korea" data-kt-select2-country="/theme/galaxy/media/flags/south-korea.svg">Hàn Quốc</option>
                                                        <option value="australia" data-kt-select2-country="/theme/galaxy/media/flags/australia.svg">Úc</option>             
                                                        <option value="brazil" data-kt-select2-country="/theme/galaxy/media/flags/brazil.svg">Brazil</option>                   
                                                        <option value="france" data-kt-select2-country="/theme/galaxy/media/flags/france.svg">Pháp</option>
                                                    </select>
                                        ...
                                        <div class="col-xxl-6">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <input class="form-control mb-5" id="node_class" name="node_class" type="number" placeholder="Nhập cấp độ máy chủ" value="0">
                                                    <label class="form-label required" for="node_group">Nhóm máy chủ</label>
                                                    <input class="form-control mb-5" data-bs-toggle="tooltip" title="0 Nghĩa là không có nhóm" id="node_group" name="node_group" type="number" placeholder="Nhập nhóm máy chủ" value="0">
                                                    <label class="form-label required" for="node_traffic_limit">Giới hạn lưu lượng</label>
                                                    <div class="input-group mb-5">
                                                        <input class="form-control" data-bs-toggle="tooltip" title="0 Nghĩa là không giới hạn" id="node_traffic_limit" name="node_traffic_limit" type="text" value="0" placeholder="Nhập giới hạn máy chủ">
                                                        <span class="input-group-text">GB</span>
                                                    </div>
                                                    <label class="form-label required" for="node_traffic_limit_reset_date">Ngày làm mới lưu lượng</label>
                                                    <input class="form-control mb-5" id="node_traffic_limit_reset_date" name="node_traffic_limit_reset_date" title="Nhập số ngày, 0 tức là không làm mới" type="text" value="1" placeholder="Nhập ngày làm mới lưu lượng">
                                                    <label class="form-label required" for="node_speedlimit">Giới hạn tốc độ</label>
                                                    <div class="input-group mb-5">
                                                        <input class="form-control" data-bs-toggle="tooltip" title="0 Nghĩa là không giới hạn" id="node_speedlimit" name="node_speedlimit" type="text" value="0" placeholder="Nhập giới hạn tốc độ">
                                                        <span class="input-group-text">Mbps</span>
                                                    </div>
                                                    <label class="form-label required" for="node_sort">Thứ tự sắp xếp</label>
                                                    <input class="form-control mb-5" data-bs-toggle="tooltip" title="Càng cao càng xếp dưới" id="node_sort" name="node_sort" type="text" value="0" placeholder="Nhập thứ tự sắp xếp">
                                                </div>
                                            </div>  
                                        </div>
                                    </div>
...
?>
        <?php echo '<script'; ?>
 src="https://cdnjs.cloudflare.com/ajax/libs/jsoneditor/9.10.2/jsoneditor.min.js"><?php echo '</script'; ?>
>
        <?php echo '<script'; ?>
 src="/js/sodium.js" async><?php echo '</script'; ?>
>
        <?php echo '<script'; ?>
>
