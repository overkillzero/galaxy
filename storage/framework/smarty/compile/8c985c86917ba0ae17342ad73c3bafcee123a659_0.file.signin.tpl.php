...
>
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			<style>body { background-image: url(<?php if (empty($_smarty_tpl->tpl_vars['config']->value['website_auth_background_image'])) {?>'/theme/galaxy/media/auth/bg4.jpg'<?php } else {
echo $_smarty_tpl->tpl_vars['config']->value['website_auth_background_image'];
}?>); } [data-bs-theme="dark"] body { background-image: url(<?php if (empty($_smarty_tpl->tpl_vars['config']->value['website_auth_background_image'])) {?>'/theme/galaxy/media/auth/bg4-dark.jpg'<?php } else {
echo $_smarty_tpl->tpl_vars['config']->value['website_auth_background_image'];
}?>); }</style>
