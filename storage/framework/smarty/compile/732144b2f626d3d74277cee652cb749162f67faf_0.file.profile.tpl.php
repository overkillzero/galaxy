<?php
/* Smarty version 4.3.4, created on 2023-12-05 11:21:39
  from '/www/wwwroot/sieuthi5g.com/resources/views/zero/user/profile.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_656e9743cdde75_76396340',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '732144b2f626d3d74277cee652cb749162f67faf' => 
    array (
      0 => '/www/wwwroot/sieuthi5g.com/resources/views/zero/user/profile.tpl',
      1 => 1701742760,
      2 => 'file',
    ),
  ),
...
function content_656e9743cdde75_76396340 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="vi">
    <head>
...
" alt="image">
                                                        ...
                                                        <a class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-3"><?php echo $_smarty_tpl->tpl_vars['user']->value->email;?>
</a>
                                                        <div class="mb-9">
                                                            <div class="badge badge-lg badge-light-primary d-inline">Cấp độ:&nbsp; <?php echo $_smarty_tpl->tpl_vars['user']->value->getPermission($_smarty_tpl->tpl_vars['user']->value->class);?>
</div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div id="kt_user_view_details" class="collapse show" style>
                                                        <div class="pb-5 fs-6">
                                                            ...
                                                            <div class="text-gray-600"><?php if ($_smarty_tpl->tpl_vars['user']->value->last_signin_time == null) {?>Không có dữ liệu<?php } else {
                                                ...
                                                <div class="card card-flush mb-5">
                                                    <div class="card-header pt-5">
                                                        <div class="card-title d-flex flex-column">
                                                            <span class="fs-2hx fw-bolder text-dark me-2 lh-1 ls-n2" id="wallet_total"><?php echo $_smarty_tpl->tpl_vars['user']->value->commission+$_smarty_tpl->tpl_vars['user']->value->money;?>
₫</span>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table align-middle table-row-dashed gy-5" id="kt_table_users_login_session">
                                                                <tbody class="fs-6 fw-semibold text-gray-600">
                                                                    ...
                                                                    <tr>
                                                                        <td>Telegram</td>
                                                                        <td><?php if ($_smarty_tpl->tpl_vars['user']->value->telegram_id == null) {?>Chưa liên kết<?php } else {
...
" target="_blank" class="btn btn-icon btn-active-light-primary w-30px h-30px ms-auto" data-bs-toggle="tooltip" data-bs-title="Ấn để liên kết Telegram">
                                                                                <span class="svg-icon svg-icon-3">
                                                                    ...
                                                                    <tr>
                                                                        <td>Hạn sử dụng</td>
                                                                        <td><?php if ($_smarty_tpl->tpl_vars['user']->value->class <= 0) {?>Chưa mua gói<?php } else {
                        ...
                        <form>
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="withdraw_method" data-style="btn-primary">	
                                    ...
                                    <option value="MOMO" data-kt-select2-image="/theme/infinity/media/payment_logo/momo.svg">MOMO</option>
                                    <option value="BANK" data-kt-select2-image="/theme/infinity/media/payment_logo/bank.svg">Ngân hàng</option>
                        ...
                        <ul class="nav nav-pills row nav-primary mb-3 mt-3" role="tablist" id="withdraw_type">
                            ...
                            <li class="nav-item d-flex col flex-grow-1 flex-shrink-0 mr-3 mb-3 mb-lg-0">
                                <a class="btn btn-outline btn-outline-dashed btn-active-light-primary text-start d-flex flex-grow-1 flex-column align-items-center" data-bs-toggle="pill" data-type="2">
                                    ...
                                    <small>Không nhỏ hơn: <?php echo $_smarty_tpl->tpl_vars['config']->value['withdraw_minimum_amount'];?>
</small></span>
                                </a>
                            </li>
                            <?php }?>
