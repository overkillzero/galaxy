<?php
/* Smarty version 4.3.4, created on 2023-12-16 21:19:08
  from '/www/wwwroot/sieuthi5g.com/resources/views/zero/admin/index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_657da3cca1b651_24180897',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5437adb125b2c7610bc0e5140009b2254e3c3984' => 
    array (
      0 => '/www/wwwroot/sieuthi5g.com/resources/views/zero/admin/index.tpl',
      1 => 1702730076,
      2 => 'file',
    ),
  ),
...
function content_657da3cca1b651_24180897 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="vi">
    <head>
        <title><?php echo $_smarty_tpl->tpl_vars['config']->value["website_name"];?>
 Bảng điều khiển</title>
												...
												<div class="card-header border-0">
													<div class="card-title d-flex flex-column">
                                                        <div class="d-flex align-items-center">
                                                            <span class="text-dark fs-2hx fw-bold me-2" data-kt-countup="true" data-kt-countup-value=<?php echo $_smarty_tpl->tpl_vars['income_this_month']->value;?>
 data-kt-countup-decimal-places="2" data-kt-countup-prefix="₫">0</span>
                                                        
                                                            <span class="badge badge-light-success fs-base" data-bs-toggle="tooltip" title="Tỷ lệ tăng so với tháng trước">                                                                                               
                                                                ...
                                                                <span data-kt-countup="true" data-kt-countup-value=<?php echo $_smarty_tpl->tpl_vars['increase_percentage_income']->value;?>
 data-kt-countup-suffix="%">0</span>
                                                            </span>
                                                        
                                                        </div>
                                                        <span class="text-gray-400 pt-1 fw-semibold fs-6">Thu nhập tháng này</span>
                                                    </div>
												</div>     
                                            ...
                                            <div class="card card-flush">
												<div class="card-header border-0">
													<div class="card-title">Sử dụng lưu lượng truy cập trong vòng 7 ngày</div>
												</div>     
												<div class="card-body pt-0">
                                        ...
                                        <div class="col-xxl-6">
											<div class="card card-flush mb-5">
												<div class="card-header border-0">
													<div class="card-title d-flex flex-column">
                                                        <div class="d-flex align-items-center">
                                                            <span class=" text-dark fs-2hx fw-bold me-2" data-kt-countup="true" data-kt-countup-value=<?php echo $_smarty_tpl->tpl_vars['new_users_this_month']->value;?>
>0</span>
                                                            <span class="badge badge-light-success fs-base" data-bs-toggle="tooltip" title="Tỷ lệ tăng so với tháng trước">                                                                                               
                                                                <span class="svg-icon svg-icon-5 svg-icon-success ms-n1">
                                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                ...
                                                                <span data-kt-countup="true" data-kt-countup-value=<?php echo $_smarty_tpl->tpl_vars['increase_percentage_new_users']->value;?>
 data-kt-countup-suffix="%">0</span>
                                                            </span>
                                                        </div>
                                                        <span class="text-gray-400 pt-1 fw-semibold fs-6">Người dùng mới trong tháng này</span>
                                                    </div>
												</div>     
												<div class="card-body pt-0">
                                            ...
                                            <div class="card card-flush">
												<div class="card-header border-0">
													<div class="card-title">Xếp hạng lưu lượng truy cập của người dùng hàng ngày</div>
												</div>     
												<div class="card-body pt-0">
...
>
            ...
            var url = '/<?php echo $_smarty_tpl->tpl_vars['config']->value['website_admin_path'];?>
/ajax_data/chart/income';
            var date = new Date();
            $.ajax({
                dataType: "json",
                url: url,
...
>
            $.ajax({
                dataType: "json",
                url: '/<?php echo $_smarty_tpl->tpl_vars['config']->value['website_admin_path'];?>
/ajax_data/chart/user_traffic_ranking',
                type: "POST",
                data: {},
                success: function(data) {
