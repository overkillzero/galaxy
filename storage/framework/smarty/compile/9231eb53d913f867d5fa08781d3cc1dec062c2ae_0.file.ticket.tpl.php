<?php
/* Smarty version 4.3.4, created on 2023-12-05 10:21:26
  from '/www/wwwroot/sieuthi5g.com/resources/views/zero/user/ticket/ticket.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_656e8926ebfbb4_77009259',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9231eb53d913f867d5fa08781d3cc1dec062c2ae' => 
    array (
      0 => '/www/wwwroot/sieuthi5g.com/resources/views/zero/user/ticket/ticket.tpl',
      1 => 1701742760,
      2 => 'file',
    ),
  ),
...
function content_656e8926ebfbb4_77009259 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="vi">
    <head>
									...
									<div class="card">
										<div class="card-header align-items-center py-5 gap-2 gap-md-5">
											...
											<div class="card-toolbar">
												...
												<i class="bi bi-cloud-plus fs-2"></i>Tạo phiếu hỗ trợ
												</button>
											</div>
										</div>
				...
				<div class="modal-content rounded">
					...
					<div class="modal-body scroll-y pt-0 pb-15 px-5 px-xl-20">
						<div class="mb-13 text-center">
							<h1 class="mb-3">Tạo phiếu hỗ </h1>
						</div>
						<form class="rounded border mt-10">
							<div class="d-block">
								<div class="border-bottom">
									<select id="zero_user_create_ticket_type" class="form-select" data-control="select2" data-hide-search="true" data-placeholder="Chọn vấn đề cần hỗ trợ">
										<option></option>
								...
								<div class="border-bottom">
									<input class="form-control border-0 px-8 min-h-45px" id="zero_user_create_ticket_title" placeholder="Tiêu đề" />
								</div>
