...
/* Smarty version 4.3.4, created on 2023-12-05 10:21:18
  from '/www/wwwroot/sieuthi5g.com/resources/views/zero/include/index/menu.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_656e891ef0bdb9_56033752',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '85614f19fac5da593ddcf31e494cd7f373002708' => 
    array (
      0 => '/www/wwwroot/sieuthi5g.com/resources/views/zero/include/index/menu.tpl',
      1 => 1701742760,
      2 => 'file',
    ),
  ),
...
function content_656e891ef0bdb9_56033752 (Smarty_Internal_Template $_smarty_tpl) {
                            ...
                            <div class="app-navbar flex-shrink-0">
                                ...
                                <div class="app-navbar-item ms-1 ms-lg-3">
                                    <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px position-relative" id="kt_drawer_chat_toggle">
                                        ...
                                        <span class="position-absolute top-0 start-100 translate-middle  badge badge-circle badge-danger w-15px h-15px ms-n4 mt-3"><?php echo count($_smarty_tpl->tpl_vars['anns']->value);?>
</span>                              
                                    </div>
                                </div>
                                <!--
                                        ...
                                        <div class="menu-item px-3 my-0">
                                            <a href="#" class="menu-link px-3 py-2 btn btn-active-light-primary" onclick="changeCurrentLanguage('en-US')">
                                                <span class="symbol symbol-20px me-4">
                                                    <img class="rounded-1" src="/theme/galaxy/media/flags/united-states.svg" alt="" />
                                                </span>Tiếng Việt
                                            </a>
                                        </div>	
                                        <div class="menu-item px-3 my-0">
                                            <a href="#" class="menu-link px-3 py-2 btn btn-active-light-primary" onclick="changeCurrentLanguage('zh-CN')">
                                                <span class="symbol symbol-20px me-4">
                                                    <img class="rounded-1" src="/theme/galaxy/media/flags/china.svg" alt="" />
                                                </span>Tiếng Anh
                                            </a>
                                        </div>										
                                    </div>
                                        ...
                                        <div class="menu-item px-3">
                                            <div class="menu-content d-flex align-items-center px-3">
                                                <div class="symbol symbol-50px me-5">
                                                    <img alt="gravatar" src="<?php echo $_smarty_tpl->tpl_vars['user']->value->gravatar;?>
" />
                                                </div>
                                                <div class="d-flex flex-column">
                                                    <a class="badge badge-light-success fw-bold fs-8">Cấp độ:&nbsp; <?php echo $_smarty_tpl->tpl_vars['user']->value->getPermission($_smarty_tpl->tpl_vars['user']->value->class);?>
</a>
                                                    <a class="fw-semibold text-muted text-hover-primary fs-7"><?php echo $_smarty_tpl->tpl_vars['user']->value->email;?>
</a>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
                            <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
                                <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                                    ...
                                    <div class="menu-item menu-accordion">
                                        <a class="menu-link" href="/<?php echo $_smarty_tpl->tpl_vars['config']->value['website_admin_path'];?>
/dashboard">
                                            <span class="menu-icon">
                        ...
                        <div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
                            <a href="<?php echo $_smarty_tpl->tpl_vars['config']->value['telegram_group_url'];?>
" target="_blank" class="btn btn-flex flex-center btn-custom btn-primary overflow-hidden text-nowrap px-0 h-40px w-100" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" title="Tham gia nhóm zalo">
