<?php
/* Smarty version 4.3.4, created on 2023-12-17 10:03:33
  from '/www/wwwroot/sieuthi5g.com/resources/views/zero/admin/node/edit.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_657e56f5580681_31993826',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'bddef3ba773c80f2044b222e38c2edb16e79e323' => 
    array (
      0 => '/www/wwwroot/sieuthi5g.com/resources/views/zero/admin/node/edit.tpl',
      1 => 1701742760,
      2 => 'file',
    ),
  ),
...
function content_657e56f5580681_31993826 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="vi">

<head>
    <title><?php echo $_smarty_tpl->tpl_vars['config']->value["website_name"];?>
 Chỉnh sửa máy chủ</title>
    <meta charset="UTF-8" />
                        ...
                        <div class="card card-stretch">
                            <div class="card-body">
                                ...
                                <input class="form-control mb-5" id="name" name="name" type="text"
                                    placeholder="Nhập tên máy chủ" value="<?php echo $_smarty_tpl->tpl_vars['node']->value->name;?>
">
                                ...
                                <input class="form-control mb-5" data-bs-toggle="tooltip"
                                    ...
                                    placeholder="Nhập địa chỉ máy chủ" value="<?php echo $_smarty_tpl->tpl_vars['node']->value->server;?>
">
                                ...
                                <input class="form-control mb-5" id="node_ip" name="node_ip"
                                    ...
                                    placeholder="Nhập IP máy chủ" value="<?php echo $_smarty_tpl->tpl_vars['node']->value->node_ip;?>
">
                                ...
                                <input class="form-control mb-5" id="traffic_rate" name="traffic_rate" type="text"
                                    placeholder="Nhập tỉ lệ tính lưu lượng" value="<?php echo $_smarty_tpl->tpl_vars['node']->value->traffic_rate;?>
">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input class="form-control mb-5" id="node_class" name="node_class" type="number"
                                    placeholder="Nhập cấp độ máy chủ" value="<?php echo $_smarty_tpl->tpl_vars['node']->value->node_class;?>
">
                                ...
                                <input class="form-control mb-5" data-bs-toggle="tooltip"
                                    ...
                                    placeholder="Nhập nhóm máy chủ" value="<?php echo $_smarty_tpl->tpl_vars['node']->value->node_group;?>
">
                                ...
                                <div class="input-group mb-5">
                                    <input class="form-control" data-bs-toggle="tooltip"
                                        ...
                                        value="<?php echo $_smarty_tpl->tpl_vars['node']->value->node_traffic_limit/1024/1024/1024;?>
"
                                ...
                                <input class="form-control mb-5" id="node_traffic_limit_reset_date"
                                    ...
                                    type="text" value="<?php echo $_smarty_tpl->tpl_vars['node']->value->node_traffic_limit_reset_date;?>
"
                                ...
                                <div class="input-group mb-5">
                                    <input class="form-control" data-bs-toggle="tooltip"
                                        ...
                                        type="text" value="<?php echo $_smarty_tpl->tpl_vars['node']->value->node_speedlimit;?>
" placeholder="Nhập giới hạn tốc độ">
                                ...
                                <input class="form-control mb-5" data-bs-toggle="tooltip" title="Càng cao càng xếp dưới"
                                    id="node_sort" name="node_sort" type="text" value="<?php echo $_smarty_tpl->tpl_vars['node']->value->node_sort;?>
"
